...
def deal_one_card():
  global card_counter
  one_card = shoe[card_counter] # each card dealt corresponds with position in shoe (i.e., first card dealt is position "0" in shoe, second card dealt is position "1" in shoe) 
  card_counter += 1
  return one_card  
